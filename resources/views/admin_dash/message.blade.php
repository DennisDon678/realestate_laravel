    ...
    <div class="container-xl">
        ...
        <div class="app-card app-card-notification shadow-sm mb-4">
            ...
            <div class="app-card-footer px-4 py-3">
                <a class="action-link" href="/admins/inbox/{{$ticket->ticket_id}}/reply">Reply<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-right ms-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
