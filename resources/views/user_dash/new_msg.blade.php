            ...
            <div class="app-card col-12 col-lg-8 mx-auto">
                <div class="app-card-header p-3">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-auto">
                            <h4 class="app-card-title">New Ticket Form</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="auth-form-container app-card-body p-3 p-lg-4 text-left">
                    ...
                    <form class="auth-form resetpass-form" action="/dashboard/tickets/new" method="POST">
                        @csrf
                        ...
                        <div class="email mb-3">
                            <label class="sr-only" for="reg-email">Title</label>
                            <input id="reg-email" name="title" type="text" class="form-control login-email" placeholder="Title of your ticket" required="required">
                        </div>
                        <!--//form-group-->
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn app-btn-primary btn-block theme-btn mx-auto">Create Ticket</button>
                        </div>
                    </form>
                </div>
            </div>
